...
def test_migrate_callback_called(mocker):
    mocker.patch("septentrion.migration.run_script")
    mocker.patch("septentrion.db.is_schema_initialized", return_value=False)
    mocker.patch("septentrion.migration.init_schema")
    mocker.patch("septentrion.db.write_migration")
    ...
    migration.migrate(settings=settings, migration_applied_callback=callback)

    assert callback.call_args_list == [
        call("1.0", "1.0-0-version-dml.sql"),
        call("1.0", "1.0-author-1-ddl.sql"),
        call("1.0", "1.0-author-2-dml.sql"),
        call("1.0", "1.0-book-1-ddl.sql"),
        call("1.0", "1.0-book-2-dml.sql"),
        call("1.1", "1.1-0-version-dml.sql"),
        call("1.1", "1.1-add-num-pages-1-ddl.sql"),
        call("1.1", "1.1-add-num-pages-2-dml.sql"),
        call("1.1", "1.1-index-ddl.sql"),
    ]
